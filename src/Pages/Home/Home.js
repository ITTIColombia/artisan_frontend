              ...
              <div className="container-fluid">
                  ...
                  <div className="aboutUs-artisans row align-items-center">
                      <div className="col-12 d-block d-lg-none">
                          <img id="aboutUs-artisans-small-image" src="/Assets/Photos/Home/Mockup.png" alt="Mockups"/>
                      </div>
                  ...
                  <div className="aboutUs-behindITTI row">
                      ...
                      <div className="col-12 col-lg-6 text-center">
                          <img id="team1imageSmall" src="/Assets/Photos/Home/Team1.png" alt="ITTI Team #1" className="d-block d-lg-none"/>
                          <p><FormattedMessage id="TeamITTI"/></p>
                          <img id="team1image" src="/Assets/Photos/Home/Team1.png" alt="ITTI Team #1" className="d-none d-lg-block"/>
                      </div>
                      <div className="col-lg-6 text-center aboutUs-team2-col d-none d-lg-block">
                          <img id="team2image" src="/Assets/Photos/Home/Team2.png" alt="ITTI Team #2"/>
                      </div>
                  </div>
              </div>
